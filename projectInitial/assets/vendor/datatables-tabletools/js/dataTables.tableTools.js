...
TableTools.prototype = {
	  ...
	  var nButton = this._fnButtonBase( oConfig, bCollectionButton );
		...
		if ( this.s.dt.iTabIndex !== -1 ) {
			$(nButton)
				...
				.on( 'http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/assets/vendor/datatables-tabletools/js/keyup.DTTT', function (e) {
				...
				.on( 'http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/assets/vendor/datatables-tabletools/js/mousedown.DTTT', function (e) {
	...
	"_fnPrintStart": function ( oConfig )
	{
	  ...
	  var oSetDT = this.s.dt;
		 ...
		 */
		$(document).bind( "http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/assets/vendor/datatables-tabletools/js/keydown.DTTT", function(e) {
	...
	"_fnPrintEnd": function ( e )
	{
		...
		$(document).unbind( "http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/assets/vendor/datatables-tabletools/js/keydown.DTTT" );
	},
...
TableTools.BUTTONS = {
	...
	"ajax": $.extend( {}, TableTools.buttonBase, {
		"sAjaxUrl": "http://demo.thedevelovers.com/xhr.php",
 ...
 */
TableTools.DEFAULTS = {
	"sSwfPath":        "../swf/copy_csv_xls_pdf.swf"/*tpa=http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/assets/vendor/datatables-tabletools/swf/copy_csv_xls_pdf.swf*/,
	"sRowSelect":      "none",
	"sRowSelector":    "tr",
	"sSelectedClass":  null,
	"fnPreRowSelect":  null,
