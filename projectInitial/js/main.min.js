(function($) {
	...
	Core.module = {
		...
		menu_active:function(){
			$('.menu').on('click','.sub-menu a',function(){
				$('.menu .sub-menu a').parent().removeClass('current')
		...
		accordion: function(){
			$(".js__accordion").each(function(){
				var selector = $(this);
				selector.find(".js__control").on("click",function(e){
					...
					if ($(this).parent().hasClass("active")){
						...
						parent.find(".active").children(".js__content").stop().slideUp(400);
