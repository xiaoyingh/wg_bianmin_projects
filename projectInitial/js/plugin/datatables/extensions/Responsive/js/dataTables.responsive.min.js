...
*/
(function(c){"function"http://demo.ninjateam.org/html/my-admin/light/assets/plugin/datatables/extensions/Responsive/js/===typeof define&&define.amd?define(["jquery","http://demo.ninjateam.org/html/my-admin/light/assets/plugin/datatables/extensions/Responsive/js/datatables.net"],function(l){return c(l,window,document)}):"object"===typeof exports?module.exports=function(l,k){l||(l=window);if(!k||!k.fn.dataTable)k=require("http://demo.ninjateam.org/html/my-admin/light/assets/plugin/datatables/extensions/Responsive/js/datatables.net")(l,k).$;return c(k,l,l.document)}:c(jQuery,window,document)})(function(c,l,k,p){var m=c.fn.dataTable,j=function(a,b){if(!m.versionCheck||!m.versionCheck("1.10.3"))throw"DataTables Responsive requires DataTables 1.10.3 or newer";this.s={dt:new m.Api(a),columns:[],
current:[]};this.s.dt.settings()[0].responsive||(b&&"string"===typeof b.details?b.details={type:b.details}:b&&!1===b.details?b.details={type:!1}:b&&!0===b.details&&(b.details={type:"inline"}),this.c=c.extend(!0,{},j.defaults,m.defaults.responsive,b),a.responsive=this,this._constructor())};c.extend(j.prototype,{_constructor:function(){var a=this,b=this.s.dt,d=b.settings()[0],e=c(l).width();b.settings()[0]._responsive=this;c(l).on("http://demo.ninjateam.org/html/my-admin/light/assets/plugin/datatables/extensions/Responsive/js/resize.dtr orientationchange.dtr",m.util.throttle(function(){var b=
c(l).width();b!==e&&(a._resize(),e=b)}));d.oApi._fnCallbackReg(d,"aoRowCreatedCallback",function(e){-1!==c.inArray(!1,a.s.current)&&c("td, th",e).each(function(e){e=b.column.index("toData",e);!1===a.s.current[e]&&c(this).css("display","none")})});b.on("http://demo.ninjateam.org/html/my-admin/light/assets/plugin/datatables/extensions/Responsive/js/destroy.dtr",function(){b.off(".dtr");c(b.table().body()).off(".dtr");c(l).off("http://demo.ninjateam.org/html/my-admin/light/assets/plugin/datatables/extensions/Responsive/js/resize.dtr orientationchange.dtr");c.each(a.s.current,function(b,e){!1===e&&a._setColumnVis(b,!0)})});this.c.breakpoints.sort(function(a,b){return a.width<b.width?1:a.width>
b.width?-1:0});this._classLogic();this._resizeAuto();d=this.c.details;!1!==d.type&&(a._detailsInit(),b.on("http://demo.ninjateam.org/html/my-admin/light/assets/plugin/datatables/extensions/Responsive/js/column-visibility.dtr",function(){a._classLogic();a._resizeAuto();a._resize()}),b.on("http://demo.ninjateam.org/html/my-admin/light/assets/plugin/datatables/extensions/Responsive/js/draw.dtr",function(){a._redrawChildren()}),c(b.table().node()).addClass("dtr-"+d.type));b.on("http://demo.ninjateam.org/html/my-admin/light/assets/plugin/datatables/extensions/Responsive/js/column-reorder.dtr",function(){a._classLogic();a._resizeAuto();a._resize()});b.on("http://demo.ninjateam.org/html/my-admin/light/assets/plugin/datatables/extensions/Responsive/js/column-sizing.dtr",function(){a._resizeAuto();a._resize()});b.on("http://demo.ninjateam.org/html/my-admin/light/assets/plugin/datatables/extensions/Responsive/js/init.dtr",function(){a._resizeAuto();a._resize();c.inArray(false,
...
d[0]+")(\\-[_a-zA-Z0-9])?"));c&&(f=!0,c[2]===d[0]&&c[3]==="-"+d[1]?g(e,b.name,c[1],c[2]+c[3]):c[2]===d[0]&&!c[3]&&g(e,b.name,c[1],c[2]))})}f||(a.auto=!0)});this.s.columns=e},_detailsDisplay:function(a,b){var d=this,e=this.s.dt,f=this.c.details;if(f&&!1!==f.type){var g=f.display(a,b,function(){return f.renderer(e,a[0],d._detailsObj(a[0]))});(!0===g||!1===g)&&c(e.table().node()).triggerHandler("http://demo.ninjateam.org/html/my-admin/light/assets/plugin/datatables/extensions/Responsive/js/responsive-display.dt",[e,a,g,b])}},_detailsInit:function(){var a=this,b=this.s.dt,d=this.c.details;"inline"===
d.type&&(d.target="td:first-child, th:first-child");b.on("http://demo.ninjateam.org/html/my-admin/light/assets/plugin/datatables/extensions/Responsive/js/draw.dtr",function(){a._tabIndexes()});a._tabIndexes();c(b.table().body()).on("http://demo.ninjateam.org/html/my-admin/light/assets/plugin/datatables/extensions/Responsive/js/keyup.dtr","td, th",function(a){a.keyCode===13&&c(this).data("dtr-keyboard")&&c(this).click()});var e=d.target;c(b.table().body()).on("http://demo.ninjateam.org/html/my-admin/light/assets/plugin/datatables/extensions/Responsive/js/click.dtr mousedown.dtr mouseup.dtr","string"===typeof e?e:"td, th",function(d){if(c(b.table().node()).hasClass("collapsed")&&b.row(c(this).closest("tr")).length){if(typeof e==="number"){var g=e<0?b.columns().eq(0).length+e:e;if(b.cell(this).index().column!==
...
!g[h].control){e=!0;break}c(b.table().node()).toggleClass("collapsed",e);var k=!1;b.columns().eq(0).each(function(b,c){i[c]!==j[c]&&(k=!0,a._setColumnVis(b,i[c]))});k&&(this._redrawChildren(),c(b.table().node()).trigger("http://demo.ninjateam.org/html/my-admin/light/assets/plugin/datatables/extensions/Responsive/js/responsive-resize.dt",[b,this.s.current]))},_resizeAuto:function(){var a=this.s.dt,b=this.s.columns;if(this.c.auto&&-1!==c.inArray(!0,c.map(b,function(a){return a.auto}))){a.table().node();var d=a.table().node().cloneNode(!1),e=c(a.table().header().cloneNode(!1)).appendTo(d),f=c(a.table().body()).clone(!1,
...
c(k).off("http://demo.ninjateam.org/html/my-admin/light/assets/plugin/datatables/extensions/Responsive/js/keypress.dtr")},g=c('<div class="dtr-modal"/>').append(c('<div class="dtr-modal-display"/>').append(c('<div class="dtr-modal-content"/>').append(e())).append(c('<div class="dtr-modal-close">&times;</div>').click(function(){f()}))).append(c('<div class="dtr-modal-background"/>').click(function(){f()})).appendTo("body");c(k).on("http://demo.ninjateam.org/html/my-admin/light/assets/plugin/datatables/extensions/Responsive/js/keyup.dtr",function(a){27===a.keyCode&&(a.stopPropagation(),f())})}a&&a.header&&c("div.dtr-modal-content").prepend("<h2>"+a.header(b)+"</h2>")}}};j.renderer={listHidden:function(){return function(a,
