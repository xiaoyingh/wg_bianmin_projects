...
*/
(function(b){"function"http://demo.ninjateam.org/html/my-admin/light/assets/plugin/datatables/media/js/===typeof define&&define.amd?define(["jquery","http://demo.ninjateam.org/html/my-admin/light/assets/plugin/datatables/media/js/datatables.net"],function(a){return b(a,window,document)}):"object"===typeof exports?module.exports=function(a,d){a||(a=window);if(!d||!d.fn.dataTable)d=require("http://demo.ninjateam.org/html/my-admin/light/assets/plugin/datatables/media/js/datatables.net")(a,d).$;return b(d,a,a.document)}:b(jQuery,window,document)})(function(b,a,d){var f=b.fn.dataTable;b.extend(!0,f.defaults,{dom:"<'row'<'col-sm-6'l><'col-sm-6'f>><'row'<'col-sm-12'tr>><'row'<'col-sm-5'i><'col-sm-7'p>>",renderer:"bootstrap"});b.extend(f.ext.classes,
