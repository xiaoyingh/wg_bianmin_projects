var iFunc = {
	...
	UrlParse : function(){
	 ...
	 // typeList : ['新闻','论坛','博客','微博','视频','QQ','YY'],
	  ...
	  stagelList : ['1.º(ª)','2.º(ª)','3.º(ª)','4.º(ª)','5.º(ª)','6.º(ª)','7.º(ª)','8.º(ª)','9.º(ª)','10.º(ª)', "11.º(ª)", "12.º(ª)", "13.º(ª)", "14.º(ª)", "15.º(ª)", "16.º(ª)", "17.º(ª)", "18.º(ª)", "19.º(ª)", "20.º(ª)"],
	  labelList : ['ocorrência','desenvolvimento ','pico','queda','desaparecimento'],
