...
//		'昨天': [moment().subtract(1, 'days'), moment().subtract(1, 'days')],
		...
		'Últimos 30 Dias': [moment().subtract(1, 'months'), moment()],
...
var daterangepicker_minute = function (s_times,e_times) {
	...
	var obj = {
		...
		ranges: {
			'Hoje': [moment().format("YYYY-MM-DD 00:00:00"), moment().format("YYYY-MM-DD 23:59:59")],
			'Últimos 7 Dias': [moment().subtract(7, 'days'), moment()],
			'Últimos 30 Dias': [moment().subtract(1, 'months'), moment()],
			'Últimos 3 Meses': [moment().subtract(3, 'months'), moment()],
		},
...
var daterangepicker_minute_max = function (s_times,e_times) {
	...
	var obj = {
		...
		ranges: {
			'Hoje': [moment().format("YYYY-MM-DD 00:00:00"), moment().format("YYYY-MM-DD 23:59:59")],
			'Últimos 7 Dias': [moment().subtract(7, 'days').format("YYYY-MM-DD 00:00:00"), moment().format("YYYY-MM-DD 23:59:59")],
			'Últimos 30 Dias': [moment().subtract(1, 'months').format("YYYY-MM-DD 00:00:00"), moment().format("YYYY-MM-DD 23:59:59")],
			'Últimos 3 Meses': [moment().subtract(3, 'months').format("YYYY-MM-DD 00:00:00"), moment().format("YYYY-MM-DD 23:59:59")],
		},
		"alwaysShowCalendars": true,
		opens:'right',
		buttonClasses: ['btn btn-default'],
...
var daterangepicker_callback = function(start, end, label) {
					if (label == 'Ilimitado') {
						...
						if (label == 'Intervalo personalizado' && stime != etime) {
							$(".one_day_search").hide();
						} else {
							$(".one_day_search").show();
						}
