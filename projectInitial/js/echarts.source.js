...
define('echarts2/chart/tree', ['require', './base', '../util/shape/Icon', 'zrender/shape/Image', 'zrender/shape/Line', 'zrender/shape/BezierCurve', '../layout/Tree', '../data/Tree', '../config', '../util/ecData', 'zrender/config', 'zrender/tool/event', 'zrender/tool/util', '../chart'], function (require) {
...
define('echarts2/layout/Tree', ['require', 'zrender/tool/vector'], function (require) {
...
define('echarts2/data/Tree', ['require', 'zrender/tool/util'], function (require) {

    var zrUtil = require('zrender/tool/util');

    /**
     * @constructor module:echarts2/data/Tree~TreeNode
    ...
    function TreeNode(id, data) {
        ...
        /**
         * 子节点列表
         * @type {Array.<module:echarts2/data/Tree~TreeNode>}
         */
        this.children = [];

        /**
         * @type {module:echarts2/data/Tree~TreeNode}
         */
        this.parent = null;
    ...
    /**
     * 添加子节点
     * @param {module:echarts2/data/Tree~TreeNode} child
     */
    ...
    /**
     * @param  {string} id
     * @return module:echarts2/data/Tree~TreeNode
     */
    ...
    /**
     * @constructor
     * @alias module:echarts2/data/Tree
     * @param {string} id
     */
    function Tree(id) {
        /**
     ...
     * @return {module:echarts2/data/Tree}
     */
...
define('echarts2', ['echarts2/echarts2'], function (echarts2) { return echarts2;});
