var iPage = {
	...
	exportTip: "Exportar tudo pode demorar muito, tem certeza de exportar?",
	 ...
	 */
	gotop_html: "<div style='display:none;' id='gotopbtn' class='to_top'><a title='Voltar ao topo' href='javascript:void(0);'></a></div>",
	page_foot_html: '<div class="page_info ipage-fenye">' + '<div class="oper_div ipage-fenye-oper"><div class="select_div" style="float:left;margin-right:10px;"><input type="checkbox" class="select_all"/><span class="select_all_text">Selecione tudo</span></div><div class="oper_btn_div" style="float:left;"></div></div>' + '<div class="ipage-fenye-btn"><button class="startPage page_btn ipage-fenye-on">Primeira</button><button class="prePage page_btn ipage-fenye-on">Anterior</button><button class="nextPage page_btn ipage-fenye-on">Próxima</button><button class="endPage page_btn ipage-fenye-on" style="display:none;">Última</button><input class="pageNo_input" type="text" value="1"/><button class="ipage-fenye-on go_btn">lr</button></div>' + '<div class="ipage-fenye-info">Total：<span class="ipage-number total"></span>&nbsp;&nbsp;Páginas Totais：<span class="ipage-number totalPage"></span>&nbsp;&nbsp;Página Corrente：<span class="ipage-number pageNo"></span></div>' + "</div>",
	operBtnHtml: '<button class="ipage-fenye-on exoprt_btn">Exporte selecionados</button>&nbsp;&nbsp;<button class="ipage-fenye-on exoprt_all_btn">Exporte tudo</button>',
	container_foot_html: '<div class="page_info ipage-fenye"><div class="oper_div ipage-fenye-oper"><div class="select_div" style="float:left;margin-right:10px;"><input type="checkbox" class="select_all"/><span class="select_all_text">Selecione tudo</span></div><div class="oper_btn_div" style="float:left;"></div></div></div>',
	...
	more_html: "<div class='page_more'>Carregue mais</div>",
		...
		if(a.isRec == 1) {
			...
			if(b) {
				...
				if(b > 0 && b <= a.totalPage) {
					...
					//alert("请输入正确的页码")
					alert("Por favor entre o número de página correcto.")
				}
			} else {
				//alert("请输入正确的页码")
				alert("Por favor entre o número de página correcto.")
