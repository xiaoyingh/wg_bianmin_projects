...
if (themeSelector) {
    ...
    function selectChange(value){
        ...
        if (theme != 'default') {
            ...
            require(['js/echarts/theme/' + theme], function(tarTheme){
                curTheme = tarTheme;
...
function refresh(isBtnRefresh){
    ...
    myChart.on(ecConfig.EVENT.CLICK, function(param){
    	if(loadPieData != undefined && param.special==undefined){   
    		loadPieData(param.dataIndex);
    	}
    });
...
if (developMode) {
    ...
    var fileLocation = needMap() ? './www/js/echarts-map' : './js/echarts/echarts';
    require.config({
        paths:{ 
